 ...
 *
 */
class SendEmailToHaveReferrals {

	private final static String DEFAULT_SENT_FILE_NAME   = "sent_email_have_referrals.txt";
	private final static String DEFAULT_UNSENT_FILE_NAME = "unsent_email_have_referrals.txt";
	
	private final static Log log = LogFactory.getLog(SendEmailToHaveReferrals.class);
	...
	private static void sendEmail(String articleId){
		...
		countHql.append("select count(m) from AGMember m,com.liferay.portal.model.User u")
				...
				.append(" and m.memberId in (select distinct t.primaryKey.memberId from AGMemberTree t)")
